    ...
    public partial class Form23 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update etornam.product set ID='" + this.textBox6.Text + "' , CATEGORY='" + this.textBox2.Text + "',PRICE='"+ this.textBox3.Text +"', NAME='"+ this.textBox4.Text+ "',QUANTITY='"+ this.textBox5.Text + "' where ID='" + this.textBox1.Text+"';";
